        ...
        stage('Docker Update in Pipeline'){
            ...
            steps{
                ...
                script{
                    ...
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID takemitchy09/$JOB_NAME:v1.$BUILD_ID .'
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID takemitchy09/$JOB_NAME:latest .'
                }
            }
        }            
    }
