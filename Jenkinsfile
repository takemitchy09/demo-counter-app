        ...
        stage('Docker Update in Pipeline'){
            ...
            steps{
                ...
                script{
                    ...
                    sh 'docker image build -t -f $JOB_NAME:v1.$BUILD_ID'
                    sh 'docker image tag $JOB_NAME:v1.$BUILD_ID takemitchy09/$JOB_NAME:v1.$BUILD_ID'
                    sh 'docker image tag $JOB_NAME:v1.$BUILD_ID takemitchy09/$JOB_NAME:latest'
                }
            }
        }            
    }
